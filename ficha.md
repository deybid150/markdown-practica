...
| Tema | ¿Qué aprendí? |
|------|----------------|
| Títulos | Aprendi a estilizar los documentos de una forma visual. |
| Links | puedo nutrir mis documentos de una forma mas dinamica y divertida. |
| Imágenes | puedo darle una imagen visual, rapida y eficiente a mis documentos. |
